...
class Category(models.Model):
    cid = ShortUUIDField(unique=True, length=10, max_length=20, prefix ="cat", alphabet = "abcdefgh12345") #cat #blank = False by default means the feilds are compulsory 
...
class Vendor(models.Model):
    ...
    class Meta:
        verbose_name_plural = "Vendors"   #CATEGORYS
...
class Product(models.Model):
    ...
    #ags = models.ForeignKey(Tags,on_delete=models.SET_NULL, null=True)
...
class CartOrderItems(models.Model):
    ...
    qty = models.CharField(default=0)
    price = models.DecimalField(max_digits=10,decimal_places=2,default="1.99")
